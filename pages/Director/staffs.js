  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Gestion de Tâches" />
      ...
      <main className={styles.main}>
        <ToastContainer
          ...
          pauseOnHover
        />
        <h2 className="fs-1 fw-bold">Liste Des Employés</h2>
                    ...
                    <tr key={index}>
                      <td scope="row">
                        <Link
                          ...
                          passHref={true}
                          href={`/user/${records[item].user_id}`}
                        >
                          <span>#000{records[item].user_id}</span>
                        </Link>
                      </td>
                      <td>{records[item].username}</td>
                      <td>{records[item].email}</td>
                      <td>
                        {String(records[item].created_on).substr(0, 10) +
                          " à " +
                          String(records[item].created_on).substr(11, 8)}
                      </td>
                      <td>
                        {" "}
                        <span
                          className={`badge rounded-pill ${
                            records[item].activated === "Yes"
                              ? "bg-success"
                              : "bg-info text-black"
                          }`}
                        >
                          {" "}
                          {records[item].activated &&
                          records[item].activated !== "Yes"
                            ? "Non"
                            : "Oui"}{" "}
                        </span>{" "}
                      ...
                      <td>
                        <button
                          ...
                          onClick={() => setSelectedUser(records[item])}
                        ...
                        {records[item].activated === "No" && (
                          <button
                            onClick={() => {
                              handleActivate(records[item]);
                            }}
                            type="button"
                  ...
                  <div className="col-md-12">
                    <table className="table table-responsive table-bordered table-striped">
                      <tbody>
                        <tr>
                          <td>Identifiant:</td>
                          <td>{selectedUser && selectedUser.user_id}</td>
                        </tr>
                        <tr>
                          <td>Nom et Prénom:</td>
